...
impl From<RustAccount> for Account {
    fn from(rust_struct: RustAccount) -> Self {
        Self {
            ...
            incentive_eligible: rust_struct.incentive_eligible.map(|v| v.into()),
            pending_rewards: rust_struct.pending_rewards.into(),
            reward_base: rust_struct.reward_base.map(|v| v.into()),
            rewards: rust_struct.rewards.into(),
            round: rust_struct.round.into(),
            status: rust_struct.status.into(),
            sig_type: rust_struct.sig_type.map(|v| v.into()),
            auth_addr: rust_struct.auth_addr.map(|v| v.into()),
            last_proposed: rust_struct.last_proposed.map(|v| v.into()),
            last_heartbeat: rust_struct.last_heartbeat.map(|v| v.into()),
        }
    }
}
...
impl From<Account> for RustAccount {
    fn from(ffi_struct: Account) -> Self {
        Self {
            ...
            incentive_eligible: ffi_struct.incentive_eligible.map(|v| v.into()),
            pending_rewards: ffi_struct.pending_rewards.into(),
            reward_base: ffi_struct.reward_base.map(|v| v.into()),
            rewards: ffi_struct.rewards.into(),
            round: ffi_struct.round.into(),
            status: ffi_struct.status.into(),
            sig_type: ffi_struct.sig_type.map(|v| v.into()),
            auth_addr: ffi_struct.auth_addr.map(|v| v.into()),
            last_proposed: ffi_struct.last_proposed.map(|v| v.into()),
            last_heartbeat: ffi_struct.last_heartbeat.map(|v| v.into()),
        }
    }
}
