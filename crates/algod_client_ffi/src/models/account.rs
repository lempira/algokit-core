...
impl From<RustAccount> for Account {
    fn from(rust_struct: RustAccount) -> Self {
        Self {
            ...
            apps_local_state: rust_struct.apps_local_state.into(),
            total_apps_opted_in: rust_struct.total_apps_opted_in.into(),
            apps_total_schema: rust_struct.apps_total_schema.into(),
            apps_total_extra_pages: rust_struct.apps_total_extra_pages.into(),
            assets: rust_struct.assets.into(),
            total_assets_opted_in: rust_struct.total_assets_opted_in.into(),
            created_apps: rust_struct.created_apps.into(),
            total_created_apps: rust_struct.total_created_apps.into(),
            created_assets: rust_struct.created_assets.into(),
            total_created_assets: rust_struct.total_created_assets.into(),
            total_boxes: rust_struct.total_boxes.into(),
            total_box_bytes: rust_struct.total_box_bytes.into(),
            participation: rust_struct.participation.into(),
            incentive_eligible: rust_struct.incentive_eligible.into(),
            pending_rewards: rust_struct.pending_rewards.into(),
            reward_base: rust_struct.reward_base.into(),
            rewards: rust_struct.rewards.into(),
            round: rust_struct.round.into(),
            status: rust_struct.status.into(),
            sig_type: rust_struct.sig_type.into(),
            auth_addr: rust_struct.auth_addr.into(),
            last_proposed: rust_struct.last_proposed.into(),
            last_heartbeat: rust_struct.last_heartbeat.into(),
        }
    }
}
...
impl From<Account> for RustAccount {
    fn from(ffi_struct: Account) -> Self {
        Self {
            ...
            apps_local_state: ffi_struct.apps_local_state.into(),
            total_apps_opted_in: ffi_struct.total_apps_opted_in.into(),
            apps_total_schema: ffi_struct.apps_total_schema.into(),
            apps_total_extra_pages: ffi_struct.apps_total_extra_pages.into(),
            assets: ffi_struct.assets.into(),
            total_assets_opted_in: ffi_struct.total_assets_opted_in.into(),
            created_apps: ffi_struct.created_apps.into(),
            total_created_apps: ffi_struct.total_created_apps.into(),
            created_assets: ffi_struct.created_assets.into(),
            total_created_assets: ffi_struct.total_created_assets.into(),
            total_boxes: ffi_struct.total_boxes.into(),
            total_box_bytes: ffi_struct.total_box_bytes.into(),
            participation: ffi_struct.participation.into(),
            incentive_eligible: ffi_struct.incentive_eligible.into(),
            pending_rewards: ffi_struct.pending_rewards.into(),
            reward_base: ffi_struct.reward_base.into(),
            rewards: ffi_struct.rewards.into(),
            round: ffi_struct.round.into(),
            status: ffi_struct.status.into(),
            sig_type: ffi_struct.sig_type.into(),
            auth_addr: ffi_struct.auth_addr.into(),
            last_proposed: ffi_struct.last_proposed.into(),
            last_heartbeat: ffi_struct.last_heartbeat.into(),
        }
    }
}
