...
impl PostTransactionSignResponse {
    /// Default constructor for PostTransactionSignResponse
    pub fn new() -> PostTransactionSignResponse {
        PostTransactionSignResponse::default()
    }
}
